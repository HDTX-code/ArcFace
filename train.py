...
def go_train(args):
    ...
    f3 = open(args.dict_id_species_path, 'r')
    ...
    model = get_model(args.backbone, args.pretrained, num_classes=512 + len(dict_id_species))
    if args.model_path != "":
    ...
    # dataset
    train_dataset = ArcDataset(train_csv_train, dict_id_all, dict_id_species, args.data_train_path, args.w,
                               args.h)
    if train_csv_val is not None:
        val_dataset = ArcDataset(train_csv_val, dict_id_all, dict_id_species, args.data_train_path, args.w,
                                 args.h)
